...
const RequiredFields = {
    ...
    SEARCH_LOAD: ["fromLat", "fromLng", "toLat", "toLat", "driverLat", "driverLng", "scheduleDate"],
    SEND_OTP: ["phone"],
...
const LoadSocketMessages = {
    ...
    BOOKING_REQUESTS: "Pending",
    BOOKING_APPROVED: "BOOKING_APPROVED",
    BOOKING_APPROVED_SUCCESS: "Approved",
    BOOKING_REJECTED: "BOOKING_REJECTED",
    BOOKING_REJECTED_MESSAGE: "Declined",
    BOOKING_SUCCESS: "Booking approved successfully",
    BOOKING_CANCELLED: "BOOKING_CANCELLED",
    BOOKING_CANCELLED_MESSAGE: "Cancelled",
